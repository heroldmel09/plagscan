...
export declare class CopyleaksTranslateService {
    private _translations;
    get translations(): CopyleaksTranslations;
    /**
     * set translations for report texts.
     * @param translations a list of results ids to be filtered.
     */
    setTranslations(translations: CopyleaksTranslations): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<CopyleaksTranslateService, never>;
    static ɵprov: i0.ɵɵInjectableDeclaration<CopyleaksTranslateService>;
}
