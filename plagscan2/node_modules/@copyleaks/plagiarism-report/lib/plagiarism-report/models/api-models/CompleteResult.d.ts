...
export declare enum CompleteResultNotificationAlertSeverity {
    VeryLow = 0,
    Low = 1,
    Medium = 2,
    High = 3,
...
export declare enum EResultPreviewType {
    Batch = 0,
    Repositroy = 1,
    Internet = 2,
    Database = 3
...
export declare type ResultPreview = InternetResultPreview | DatabaseResultPreview | BatchResultPreview | RepositoryResultPreview;
/** Enum representing the access of a result */
export declare enum ResultAccess {
    full = 0,
    locked = 1
}
