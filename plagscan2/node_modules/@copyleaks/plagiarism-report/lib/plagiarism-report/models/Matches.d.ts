...
export declare type SubjectResultKey = 'source' | 'suspected';
/** possible key options for results match type */
export declare type ComparisonKey = 'identical' | 'minorChanges' | 'relatedMeaning';
/** possible key options for results content */
export declare type ContentKey = 'text' | 'html';
/** possible key options for results ranges */
export declare type MatchUnit = 'chars' | 'words';
