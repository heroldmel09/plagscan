...
export declare type PostMessageEvent = MatchClickEvent | MatchJumpEvent | MatchSelectEvent | MatchWarnEvent | UpgradePlanEvent;
...
export declare enum ECRPackageProducts {
    plagiairsm = 0,
    ai = 1
}
export {};
