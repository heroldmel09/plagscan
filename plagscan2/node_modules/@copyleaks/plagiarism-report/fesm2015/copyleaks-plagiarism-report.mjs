...
class CopyleaksService {
    constructor() {
        ...
        this._config$ = new BehaviorSubject(Object.assign({}, DEFAULT_REPORT_CONFIG));
     ...
     */
    setConfig(config) {
        this._config$.next(Object.assign({}, config));
    }
    /**
...
const mergeWordIntervals = (matches) => matches.reduce((joined, next) => {
    ...
    if (prev.end === next.end && prev.start === next.start) {
        if (next.type < prev.type) {
            joined[joined.length - 1] = Object.assign(Object.assign({}, prev), { type: next.type });
        }
    }
    ...
    // [--n--]
        ...
        if (next.type < prev.type) {
            ...
            joined.push(Object.assign(Object.assign({}, prev), { start: next.start }));
        }
    }
    // same end inclusion
    // [---p---]
    // 	[--n--]
        ...
        if (next.type < prev.type) {
            joined[joined.length - 1] = Object.assign(Object.assign({}, prev), { end: next.start });
            joined.push(next);
        }
    }
    // complete inclusion
    ...
    // [--n--]
        ...
        if (next.type < prev.type) {
            joined[joined.length - 1] = Object.assign(Object.assign({}, prev), { end: next.start });
            joined.push(next);
            joined.push(Object.assign(Object.assign({}, prev), { start: next.end }));
        }
    }
    ...
    //     [---n---]              [---n---]
        ...
        if (next.type === prev.type) {
            joined[joined.length - 1] = Object.assign(Object.assign({}, prev), { end: next.end });
        }
            ...
            joined.push(Object.assign(Object.assign({}, next), { start: prev.end }));
        }
    }
    // same start
    // [--p--]
...
class ReportService {
    constructor(copyleaksService) {
        ...
        onDeleteResultById$.pipe(untilDestroy(this)).subscribe(id => {
            ...
            this.setCompleteResult(Object.assign(Object.assign({}, currentCompleteResult), { scannedDocument: Object.assign(Object.assign({}, currentCompleteResult.scannedDocument), { totalWords: statistics.total, totalExcluded: statistics.omittedWords }), results: Object.assign(Object.assign({}, currentCompleteResult.results), { batch: currentCompleteResult.results.batch.filter(r => r.id !== id), internet: currentCompleteResult.results.internet.filter(r => r.id !== id), database: currentCompleteResult.results.database.filter(r => r.id !== id), repositories: (_a = currentCompleteResult.results.repositories) === null || _a === void 0 ? void 0 : _a.filter(r => r.id !== id), score: Object.assign(Object.assign({}, currentCompleteResult.results.score), { aggregatedScore: statistics.aggregatedScore, identicalWords: statistics.identical, relatedMeaningWords: statistics.relatedMeaning, minorChangedWords: statistics.minorChanges }) }) }));
    ...
    setCompleteResult(completeResult) {
        ...
        const previews = [
            ...(repositories && repositories.length
                ? repositories.map(r => (Object.assign(Object.assign({}, r), { type: EResultPreviewType.Repositroy })))
                : []),
            ...internet.map(r => (Object.assign(Object.assign({}, r), { type: EResultPreviewType.Internet }))),
            ...database.map(r => (Object.assign(Object.assign({}, r), { type: EResultPreviewType.Database }))),
            ...batch.map(r => (Object.assign(Object.assign({}, r), { type: EResultPreviewType.Batch }))),
        ];
    ...
    setHiddenResults(ids) {
        var _a;
        const currentCompleteResult = (_a = this._completeResult) === null || _a === void 0 ? void 0 : _a.value;
    ...
    upgradePlanEvent() {
        var _a, _b, _c, _d, _e;
        const completeResult = (_a = this._completeResult) === null || _a === void 0 ? void 0 : _a.value;
        let recommendedPagesAmount = (_b = completeResult.scannedDocument) === null || _b === void 0 ? void 0 : _b.credits;
        if ((_c = completeResult === null || completeResult === void 0 ? void 0 : completeResult.scannedDocument) === null || _c === void 0 ? void 0 : _c.expectedCredits) {
            recommendedPagesAmount =
                ((_d = completeResult === null || completeResult === void 0 ? void 0 : completeResult.scannedDocument) === null || _d === void 0 ? void 0 : _d.expectedCredits) - ((_e = completeResult.scannedDocument) === null || _e === void 0 ? void 0 : _e.credits);
        }
    ...
    hasNonAIAlerts() {
        ...
        if (((_b = (_a = completeResult === null || completeResult === void 0 ? void 0 : completeResult.notifications) === null || _a === void 0 ? void 0 : _a.alerts) === null || _b === void 0 ? void 0 : _b.filter(s => s.code != ALERTS.SUSPECTED_AI_TEXT_DETECTED).length) > 0) {
            return true;
        }
        return false;
    }
    isPlagiarismEnabled() {
        ...
        const completeResult = this._completeResult.value;
        if (completeResult) {
            if (((_b = (_a = completeResult === null || completeResult === void 0 ? void 0 : completeResult.scannedDocument) === null || _a === void 0 ? void 0 : _a.enabled) === null || _b === void 0 ? void 0 : _b.plagiarismDetection) != null)
                return (_d = (_c = completeResult === null || completeResult === void 0 ? void 0 : completeResult.scannedDocument) === null || _c === void 0 ? void 0 : _c.enabled) === null || _d === void 0 ? void 0 : _d.plagiarismDetection;
        }
        return true;
    }
    isAiDetectionEnabled() {
        ...
        const completeResult = this._completeResult.value;
        if (completeResult) {
            if ((_b = (_a = completeResult === null || completeResult === void 0 ? void 0 : completeResult.scannedDocument) === null || _a === void 0 ? void 0 : _a.enabled) === null || _b === void 0 ? void 0 : _b.aiDetection)
                return true;
            return (((_d = (_c = completeResult === null || completeResult === void 0 ? void 0 : completeResult.notifications) === null || _c === void 0 ? void 0 : _c.alerts) === null || _d === void 0 ? void 0 : _d.length) &&
                ((_e = completeResult === null || completeResult === void 0 ? void 0 : completeResult.notifications) === null || _e === void 0 ? void 0 : _e.alerts.filter(alert => alert.code == ALERTS.SUSPECTED_AI_TEXT_DETECTED).length) ==
                    1);
        }
        return false;
    }
    ...
    for (let match of matches) {
        ...
        if (match.end < pages[page + 1]) {
            ...
            while (match.end > pages[page + 1]) {
                const complement = Object.assign(Object.assign({}, match), { start: pages[page + 1] });
...
const processAICheatingMatches = (source, alertToMatch) => {
    ...
    (_a = scanResult === null || scanResult === void 0 ? void 0 : scanResult.results) === null || _a === void 0 ? void 0 : _a.forEach(result => {
        var _a;
        (_a = result === null || result === void 0 ? void 0 : result.matches) === null || _a === void 0 ? void 0 : _a.forEach((match) => {
            var _a, _b;
            const mappedMatches = (_b = (_a = match === null || match === void 0 ? void 0 : match.text.chars) === null || _a === void 0 ? void 0 : _a.starts) === null || _b === void 0 ? void 0 : _b.map((start, idx) => ({
                start,
...
class ViewModeService {
    constructor(reportService) {
        ...
        this.reportService.completeResult$.pipe(takeUntil(this._unsub)).subscribe(completeResult => {
            ...
            if (this.reportService.isPlagiarismEnabled()) {
                const hasAlerts = (_c = (_b = (_a = completeResult === null || completeResult === void 0 ? void 0 : completeResult.notifications) === null || _a === void 0 ? void 0 : _a.alerts) === null || _b === void 0 ? void 0 : _b.filter(s => s.code != ALERTS.SUSPECTED_AI_TEXT_DETECTED)) === null || _c === void 0 ? void 0 : _c.length;
                const hasResults = !!((_e = (_d = completeResult.results) === null || _d === void 0 ? void 0 : _d.batch) === null || _e === void 0 ? void 0 : _e.length) ||
                    !!((_g = (_f = completeResult.results) === null || _f === void 0 ? void 0 : _f.internet) === null || _g === void 0 ? void 0 : _g.length) ||
                    !!((_j = (_h = completeResult.results) === null || _h === void 0 ? void 0 : _h.database) === null || _j === void 0 ? void 0 : _j.length) ||
                    !!((_l = (_k = completeResult.results) === null || _k === void 0 ? void 0 : _k.repositories) === null || _l === void 0 ? void 0 : _l.length);
    ...
    showAIAlertView(completeResult) {
        ...
        const aiAlert = (_b = (_a = completeResult === null || completeResult === void 0 ? void 0 : completeResult.notifications) === null || _a === void 0 ? void 0 : _a.alerts) === null || _b === void 0 ? void 0 : _b.find(s => s.code == ALERTS.SUSPECTED_AI_TEXT_DETECTED);
        if (aiAlert) {
...
class MatchService {
    ...
    processAlertMatches(settings, source) {
        this.onSourceFirstTextMode$.subscribe(() => {
            var _a, _b, _c, _d;
            let text;
            if (((_b = (_a = this.viewModeService) === null || _a === void 0 ? void 0 : _a.selectedAlert) === null || _b === void 0 ? void 0 : _b.code) === ALERTS.SUSPECTED_CHARACTER_REPLACEMENT_CODE) {
                text = processSuspectedCharacterMatches(source, this.viewModeService.selectedAlert);
            }
            else if (((_d = (_c = this.viewModeService) === null || _c === void 0 ? void 0 : _c.selectedAlert) === null || _d === void 0 ? void 0 : _d.code) === ALERTS.SUSPECTED_AI_TEXT_DETECTED) {
...
class OptionsDialogComponent {
    ...
    ngOnInit() {
        ...
        this.reportService.options$.pipe(untilDestroy(this), take(1)).subscribe(options => (this.options = Object.assign({}, options)));
        this.dialogRef
            .beforeClosed()
            .pipe(truthy())
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.3", ngImport: i0, type: OptionsDialogComponent, decorators: [{
        ...
        return [{ type: CopyleaksTranslateService }, { type: i1.MatDialogRef }, { type: DirectionService }, { type: ReportService, decorators: [{
                        type: Inject,
...
class AlertCardComponent {
    ...
    get isSelected() {
        var _a, _b, _c;
        return ((_b = (_a = this.viewModeService) === null || _a === void 0 ? void 0 : _a.selectedAlert) === null || _b === void 0 ? void 0 : _b.code) === ((_c = this.alert) === null || _c === void 0 ? void 0 : _c.code);
    }
    /**
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.3", ngImport: i0, type: NotificationsDialogComponent, decorators: [{
        ...
        return [{ type: i1.MatDialog }, { type: ReportService, decorators: [{
                        type: Inject,
                        args: [MAT_DIALOG_DATA]
                    }] }];
    } });
...
class PropertiesComponent {
    ...
    get btnDownloadTooltip() {
        ...
        if (this.isPDFDownloading) {
            return ((_c = (_b = (_a = this.translations) === null || _a === void 0 ? void 0 : _a.SCAN_PROPERTIES_SECTION) === null || _b === void 0 ? void 0 : _b.ACTIONS) === null || _c === void 0 ? void 0 : _c.DOWNLOADING) || 'Downloading...';
        }
        else {
            return ((_f = (_e = (_d = this.translations) === null || _d === void 0 ? void 0 : _d.SCAN_PROPERTIES_SECTION) === null || _e === void 0 ? void 0 : _e.ACTIONS) === null || _f === void 0 ? void 0 : _f.DOWNLOAD) || 'Download';
        }
    }
    get isScanning() {
    ...
    get isAlertsView() {
        var _a, _b;
        return ((_b = (_a = this.viewModeService) === null || _a === void 0 ? void 0 : _a.reportViewMode$) === null || _b === void 0 ? void 0 : _b.value) === EReportViewModel.Alerts;
    }
    ...
    get isAiView() {
        var _a, _b;
        return ((_b = (_a = this.viewModeService) === null || _a === void 0 ? void 0 : _a.reportViewMode$) === null || _b === void 0 ? void 0 : _b.value) === this.eReportViewMode.AIView;
    }
    /**
        ...
        if (this.scanSummaryComponent) {
            if (!this.scanSummeryComponentInstance) {
                setTimeout(() => {
                    ...
                    if (!this.scanSummeryComponentInstance) {
                        const scanSummeryComponentInstance = (_a = this.scanSammeryComponentVcr) === null || _a === void 0 ? void 0 : _a.createComponent(factory);
                        if (scanSummeryComponentInstance) {
                            this.scanSummeryComponentInstance = scanSummeryComponentInstance;
                            if (this.metadata) {
                                (_c = (_b = this.scanSummeryComponentInstance) === null || _b === void 0 ? void 0 : _b.instance) === null || _c === void 0 ? void 0 : _c.setCompleteResult(this.metadata);
                            }
                        }
                    }
                }, 100);
    ...
    ngOnInit() {
        ...
        completeResult$.pipe(untilDestroy(this)).subscribe(meta => {
            var _a, _b;
            this.metadata = meta;
            (_b = (_a = this.scanSummeryComponentInstance) === null || _a === void 0 ? void 0 : _a.instance) === null || _b === void 0 ? void 0 : _b.setCompleteResult(this.metadata);
    ...
    get isShowingOnlyTopResults() {
        var _a;
        return (_a = this.options) === null || _a === void 0 ? void 0 : _a.showOnlyTopResults;
    }
    /**
...
class HtmlHelperBase {
    ...
    renderMatches(matches) {
        ...
        const html = matches.reduceRight((prev, curr, i) => {
            var _a;
            let slice = (_a = this.html) === null || _a === void 0 ? void 0 : _a.substring(curr.start, curr.end);
            switch (curr.type) {
            ...
            return slice ? slice === null || slice === void 0 ? void 0 : slice.concat(prev) : '';
        }, '');
        this.renderer.setAttribute(this.element.nativeElement, 'srcdoc', html + this.style + this.script);
    }
}
...
function ready$1() {
    ...
    function onMatchHover(event) {
        var _a;
        const elem = event === null || event === void 0 ? void 0 : event.target;
        (_a = elem === null || elem === void 0 ? void 0 : elem.classList) === null || _a === void 0 ? void 0 : _a.toggle('hover');
    }
}
    ...
    ngOnInit() {
        ...
        combineLatest([source$.pipe(truthy()), originalHtmlMatches$])
            ...
            if (this.lastMatchSelectEvent && this.lastMatchSelectEvent.index !== -1) {
                this.messageFrame({ type: 'match-select', index: (_a = this.lastMatchSelectEvent) === null || _a === void 0 ? void 0 : _a.index });
            }
        });
...
function ready() {
    ...
    function onMatchHover(event) {
        var _a, _b;
        const elem = event === null || event === void 0 ? void 0 : event.target;
        (_b = groups[(_a = elem === null || elem === void 0 ? void 0 : elem.dataset) === null || _a === void 0 ? void 0 : _a.gid]) === null || _b === void 0 ? void 0 : _b.forEach(el => { var _a; return (_a = el === null || el === void 0 ? void 0 : el.classList) === null || _a === void 0 ? void 0 : _a.toggle('hover'); });
    }
}
...
class OriginalTextHelperDirective {
    ...
    ngAfterContentInit() {
        ...
        viewMode$
            ...
            setTimeout(() => {
                var _a, _b, _c, _d, _e, _f;
                const start = (_c = (_b = (_a = this.lastSelectedOriginalTextMatch) === null || _a === void 0 ? void 0 : _a.elem) === null || _b === void 0 ? void 0 : _b.match) === null || _c === void 0 ? void 0 : _c.start;
                const end = (_f = (_e = (_d = this.lastSelectedOriginalTextMatch) === null || _d === void 0 ? void 0 : _d.elem) === null || _e === void 0 ? void 0 : _e.match) === null || _f === void 0 ? void 0 : _f.end;
...
class OriginalComponent {
    ...
    get hasUrl() {
        var _a, _b, _c;
        return !!((_c = (_b = (_a = this.completeResult) === null || _a === void 0 ? void 0 : _a.scannedDocument) === null || _b === void 0 ? void 0 : _b.metadata) === null || _c === void 0 ? void 0 : _c.finalUrl);
    }
    /**
    ...
    get AlertPreviewViewMode() {
        var _a, _b, _c, _d, _e, _f;
        return (((_b = (_a = this.viewModeService) === null || _a === void 0 ? void 0 : _a.reportViewMode$) === null || _b === void 0 ? void 0 : _b.value) === EReportViewModel.Alerts &&
            (((_d = (_c = this.viewModeService) === null || _c === void 0 ? void 0 : _c.selectedAlert) === null || _d === void 0 ? void 0 : _d.code) === ALERTS.SUSPECTED_CHARACTER_REPLACEMENT_CODE ||
                ((_f = (_e = this.viewModeService) === null || _e === void 0 ? void 0 : _e.selectedAlert) === null || _f === void 0 ? void 0 : _f.code) === ALERTS.SUSPECTED_AI_TEXT_DETECTED));
    }
    /**
    ...
    openUrl() {
        var _a, _b, _c;
        if (this.hasUrl) {
            window.open((_c = (_b = (_a = this.completeResult) === null || _a === void 0 ? void 0 : _a.scannedDocument) === null || _b === void 0 ? void 0 : _b.metadata) === null || _c === void 0 ? void 0 : _c.finalUrl, '_blank');
        }
    }
...
class SuspectComponent {
    ...
    get hasUrl() {
        var _a, _b, _c;
        return !!((_a = this.preview) === null || _a === void 0 ? void 0 : _a.url) || !!((_c = (_b = this.preview) === null || _b === void 0 ? void 0 : _b.metadata) === null || _c === void 0 ? void 0 : _c.finalUrl);
    }
    get pages() {
    ...
    openUrl() {
        var _a, _b, _c;
        if (this.hasUrl) {
            const url = ((_a = this.preview) === null || _a === void 0 ? void 0 : _a.url) || ((_c = (_b = this.preview) === null || _b === void 0 ? void 0 : _b.metadata) === null || _c === void 0 ? void 0 : _c.finalUrl);
...
class ResultCardComponent {
    ...
    get titleIconTooltip() {
        ...
        return !this.loading && this.result === null
            ? ((_b = (_a = this.translations) === null || _a === void 0 ? void 0 : _a.RESULT_CARD) === null || _b === void 0 ? void 0 : _b.RESULT_ERROR) || this.messages.RESULT_PUSH_ERROR
    ...
    getPreviewDate() {
        ...
        if (((_b = (_a = this.preview) === null || _a === void 0 ? void 0 : _a.metadata) === null || _b === void 0 ? void 0 : _b.creationDate) ||
            ((_d = (_c = this.preview) === null || _c === void 0 ? void 0 : _c.metadata) === null || _d === void 0 ? void 0 : _d.lastModificationDate) ||
            ((_f = (_e = this.preview) === null || _e === void 0 ? void 0 : _e.metadata) === null || _f === void 0 ? void 0 : _f.publishDate)) {
            try {
                const d = new Date((_m = (_j = (_h = (_g = this.preview) === null || _g === void 0 ? void 0 : _g.metadata) === null || _h === void 0 ? void 0 : _h.creationDate) !== null && _j !== void 0 ? _j : (_l = (_k = this.preview) === null || _k === void 0 ? void 0 : _k.metadata) === null || _l === void 0 ? void 0 : _l.lastModificationDate) !== null && _m !== void 0 ? _m : (_p = (_o = this.preview) === null || _o === void 0 ? void 0 : _o.metadata) === null || _p === void 0 ? void 0 : _p.publishDate);
    ...
    ngOnInit() {
        ...
        if ((_b = (_a = this.preview) === null || _a === void 0 ? void 0 : _a.metadata) === null || _b === void 0 ? void 0 : _b.filename) {
            let filename = (_d = (_c = this.preview) === null || _c === void 0 ? void 0 : _c.metadata) === null || _d === void 0 ? void 0 : _d.filename;
            try {
                filename = decodeURIComponent((_f = (_e = this.preview) === null || _e === void 0 ? void 0 : _e.metadata) === null || _f === void 0 ? void 0 : _f.filename);
            }
            catch (_s) {
                filename = (_h = (_g = this.preview) === null || _g === void 0 ? void 0 : _g.metadata) === null || _h === void 0 ? void 0 : _h.filename;
            }
            this.preview.metadata.filename = filename;
        }
        this.previewDate = this.getPreviewDate();
        if (((_k = (_j = this.preview) === null || _j === void 0 ? void 0 : _j.metadata) === null || _k === void 0 ? void 0 : _k.author) || ((_m = (_l = this.preview) === null || _l === void 0 ? void 0 : _l.metadata) === null || _m === void 0 ? void 0 : _m.organization) || this.previewDate) {
            const author = (_p = (_o = this.preview) === null || _o === void 0 ? void 0 : _o.metadata) === null || _p === void 0 ? void 0 : _p.author;
            const organization = (_r = (_q = this.preview) === null || _q === void 0 ? void 0 : _q.metadata) === null || _r === void 0 ? void 0 : _r.organization;
        ...
        if (this.preview.component) {
            ...
            setTimeout(() => {
                var _a;
                const ref = (_a = this.vcr) === null || _a === void 0 ? void 0 : _a.createComponent(factory);
                if (ref) {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.3", ngImport: i0, type: ResultCardComponent, decorators: [{
        ...
        return [{ type: CopyleaksTranslateService }, { type: i0.ComponentFactoryResolver }, { type: ReportService }, { type: DirectionService }, { type: i17.DatePipe }, { type: undefined, decorators: [{
                        type: Inject,
...
class ResultsComponent {
    ...
    ngOnInit() {
        ...
        results$.pipe(untilDestroy(this), delay(1000)).subscribe(results => {
            var _a;
            if ((results === null || results === void 0 ? void 0 : results.length) === ((_a = this.previews) === null || _a === void 0 ? void 0 : _a.length)) {
    ...
    listenForDisplayChange() {
        const observer = new MutationObserver(() => {
            var _a, _b, _c;
            this.isComponentDisplayed = ((_c = (_b = (_a = this.elementRef) === null || _a === void 0 ? void 0 : _a.nativeElement) === null || _b === void 0 ? void 0 : _b.style) === null || _c === void 0 ? void 0 : _c.display) !== 'none';
        });
        ...
        if (config && config.resultsOverlayComponent) {
            ...
            if (!this.resultsOverlayComponentInstance) {
                ...
                setTimeout(() => {
                    var _a;
                    if (!this.resultsOverlayComponentInstance) {
                        const resultsOverlayComponentInstance = (_a = this.vcr) === null || _a === void 0 ? void 0 : _a.createComponent(factory);
...
class AlertsComponent {
    ...
    get selectedAlert() {
        var _a;
        return (_a = this.viewModeService) === null || _a === void 0 ? void 0 : _a.selectedAlert;
    }
    /**
     * Life-cycle method
     */
...
class CopyleaksReportComponent {
    ...
    ngOnChanges(changes) {
        if (changes.config) {
            this.copyleaksService.setConfig(Object.assign({}, changes.config.currentValue));
...
class CopyleaksReportModule {
    ...
    static forRoot(config = {}, textConfig = {}) {
        return {
            ...
            providers: [
                { provide: COPYLEAKS_CONFIG_INJECTION_TOKEN, useValue: Object.assign(Object.assign({}, DEFAULT_REPORT_CONFIG), config) },
                { provide: COPYLEAKS_TEXT_CONFIG_INJECTION_TOKEN, useValue: Object.assign(Object.assign({}, DEFAULT_TEXT_CONFIG), textConfig) },
            ],
        };
    }
    /**
...
CopyleaksReportModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.3.3", ngImport: i0, type: CopyleaksReportModule, providers: [
        ...
        DirectionService,
        { provide: COPYLEAKS_CONFIG_INJECTION_TOKEN, useValue: Object.assign({}, DEFAULT_REPORT_CONFIG) },
        { provide: COPYLEAKS_TEXT_CONFIG_INJECTION_TOKEN, useValue: Object.assign({}, DEFAULT_TEXT_CONFIG) },
    ], imports: [[
            CommonModule,
            PanelModule,
            SharedModule,
