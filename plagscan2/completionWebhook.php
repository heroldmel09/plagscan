...
// Add validation for Copyleaks webhook
$headers = getallheaders();
$copyleaksSignature = isset($headers['Copyleaks-Signature']) ? $headers['Copyleaks-Signature'] : null;

// You should compare this signature with a predefined secret or token from Copyleaks
$yourSecretToken = 'b2644caf-2e7c-4d70-a313-1c73449e1e8b'; // Replace with your actual secret

if (!$copyleaksSignature || $copyleaksSignature !== $yourSecretToken) {
